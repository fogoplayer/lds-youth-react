...
const Page = props => (
  <div>
    <h2>The Living Christ</h2>

    <p>
      As we commemorate the birth of Jesus Christ two millennia ago, we offer
      our testimony of the reality of His matchless life and the infinite virtue
      of His great atoning sacrifice. None other has had so profound an
    ...
    <p>
      ...
      made” (<a href="https://www.lds.org/scriptures/nt/john/1.3">John 1:3</a>).
      Though sinless, He was baptized to fulfill all righteousness. He “went
      about doing good” (<a href="https://www.lds.org/scriptures/nt/acts/10.38">
        Acts 10:38
      </a>), yet was despised for it. His gospel was a message of peace and
    ...
    <p>
      ...
      for the sins of all mankind. His was a great vicarious gift in behalf of
    ...
    <p>
      ...
      of the Father, the Only Begotten Son in the flesh, the Redeemer of the
      world.
    </p>
    <p>
      He rose from the grave to “become the firstfruits of them that slept” (<a href="https://www.lds.org/scriptures/nt/1-cor/15.20">
        1 Cor. 15:20
      </a>). As Risen Lord, He visited among those He had loved in life. He also
      ministered among His “other sheep” (<a href="https://www.lds.org/scriptures/dc-testament/dc/20.73">
        John 10:16
      </a>) in ancient America. In the modern world, He and His Father appeared
      to the boy Joseph Smith, ushering in the long-promised “dispensation of
      the fulness of times” (<a href="https://www.lds.org/scriptures/nt/eph/1:10">
        Eph. 1:10
      </a>).
    </p>
    <p>
    ...
    <p>
      ...
      am your advocate with the Father” (<a href="https://www.lds.org/scriptures/dc-testament/dc/110.3-4">
        D&C 110:3–4
      </a>).
    </p>
    <p>
    ...
    <p>
      ...
      God” (<a href="https://www.lds.org/scriptures/dc-testament/dc/76.22-24">
        D&C 76:22–24
      </a>).
    </p>
    <p>
      We declare in words of solemnity that His priesthood and His Church have
      been restored upon the earth—“built upon the foundation of … apostles and
      prophets, Jesus Christ himself being the chief corner stone” (<a href="https://www.lds.org/scriptures/nt/eph/2.20">
        Eph. 2:20
      </a>).
    </p>
    <p>
      We testify that He will someday return to earth. “And the glory of the
      Lord shall be revealed, and all flesh shall see it together” (<a href="https://www.lds.org/scriptures/ot/isa/40.5">
        Isa. 40:5
      </a>). He will rule as King of Kings and reign as Lord of Lords, and every
    ...
    <p>
      ...
      today on the right hand of His Father. He is the light, the life, and the
      hope of the world. His way is the path that leads to happiness in this
    ...
    <p>The Quorum of the Twelve Apostles</p>
  </div>
);
