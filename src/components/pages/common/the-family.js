...
const Page = props => (
  <div>
    <h2>The Family: A Proclamation to the World</h2>
    ...
    <p>
      ...
      a beloved spirit son or daughter of heavenly parents, and, as such, each
    ...
    <p>
      IN THE PREMORTAL REALM, spirit sons and daughters knew and worshipped God
    ...
    <p>
      ...
      in force. We further declare that God has commanded that the sacred powers
    ...
    <p>
      ...
      other and for their children. “Children are an heritage of the Lord” (<a href="https://www.lds.org/scriptures/ot/psalm/127.3">
        Psalm 127:3
      </a>). Parents have a sacred duty to rear their children in love and
      righteousness, to provide for their physical and spiritual needs, and to
      teach them to love and serve one another, observe the commandments of God,
      and be law-abiding citizens wherever they live. Husbands and wives—mothers
