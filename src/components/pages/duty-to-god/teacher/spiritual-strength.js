  ...
  <div>
    ...
    <ul className="collection">
      <CollectionItem
        ...
        url="/duty-to-god/teacher/spiritual-strength/pray-and-study-the-scriptures"
      />
      <CollectionItem
        text="Live Worthily"
        url="/duty-to-god/teacher/spiritual-strength/live-worthily"
      />
      <CollectionItem
        text="Understand Doctrine"
        url="/duty-to-god/teacher/spiritual-strength/understand-doctrine"
      />
      <CollectionItem
        text="Review"
        url="/duty-to-god/teacher/spiritual-strength/review"
      />
    </ul>
  </div>
);
